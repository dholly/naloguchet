      ...
      <div class="services-accordion__container">
        ...
        <div class="services-accordion">
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text"> Сверяем выписки, остатки, корректность кассовых операций и движения по расчётным счетам.</p>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Проверяем первичные документы, счета-фактуры, книги покупок и продаж, корректность отражения НДС.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text"> Анализируем правильность расчётов по УСН/ОСНО, проверяем декларации, 6-НДФЛ, РСВ и отчёты по фондам.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Проверяем начисления, удержания, соответствие сумм в отчётности и данных по сотрудникам.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Анализируем движение ТМЦ, остатки, себестоимость, выявляем расхождения между учётом и реальностью.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Проверяем амортизацию, карточки учёта, корректность отражения операций.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Проводим сверки по налогам и взносам, выявляем долги и переплаты.</p>
              </div>
            </div>
          </div>
          ...
          <div class="services-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">Проверяем корректность проводок, настройку плана счетов, наличие первички и соответствие данным отчётности.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="faq-accordion">
          ...
          <div class="faq-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">
                  Минимум: выписки банка за проверяемый период, последняя отчётность, доступ к 1С (или выгрузка). Если чего-то не хватает — поможем восстановить или запросим у банка и контрагентов.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="faq-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">
                  Да. Работаем по договору и NDA. Доступ имеют только бухгалтер и аудитор проекта.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="faq-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">
                  Стандартный срок — до 48 часов с момента получения документов. При срочных запросах (проверка, блокировка счёта) можем сделать за 24 часа.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="faq-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">
                  Вы получите отчёт, список ошибок, приоритеты исправления и смету. Дальше можете: исправить всё самостоятельно; передать задачу своему бухгалтеру; поручить восстановление нам (в этом случае аудит бесплатен).
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="faq-accordion__item">
            ...
            <div class="accordion-item__body">
              <div class="accordion-item__content">
                <p class="accordion-body__main-text">
                  Нет. Вы оплачиваете только сам аудит (или бесплатно при восстановлении), а дальше решаете сами, хотите ли передать ведение нам.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="buh-servises-short__container">
        ...
        <div class="buh-servises-short__text-wrapper" id="seo-text-wrapper">
            <div class="buh-servises-short__text">
                <h3>Экспресс аудит бухучета — срочный аудит бухгалтерии</h3>
                <p>Проводим бухгалтерский аудит в экспресс режиме по недорогой стоимости и в сжатые сроки. Получите экспертную оценку бухгалтерии организации от профессиональных опытных бухгалтеров. Работаем с ООО, ИП, АО (ОАО и ПАО), НКО (СНТ и др). Доверьтесь экспертам Центра профессиональной бухгалтерии.</p>
                <p>Экспресс аудит проверяет состояние налогового и бухгалтерского учета в самое короткое время, его можно назвать срочным. Оказываем аудиторские услуги (как и бухгалтерские) удаленно, по принципу аутсорсинга. Ваш бизнес может находиться в Казани, Тюмени или рядом в Москве. Проверка бухгалтерии фирмы происходит в штатном режиме и без отвлечения сотрудников.</p>

                <h3>Что такое экспресс аудит бухгалтерии</h3>
                <p>Развейте сомнения в правильности ведения бухгалтерии, бухгалтерской и налоговой отчетности. Предлагаем быструю и эффективную оценку учетных процессов предприятия. Экспресс аудит бухгалтерии – это оперативная проверка, которая помогает собственнику бизнеса понять, в каком состоянии находится бухгалтерский учет.</p>
                <p><strong>Внимание!</strong> Экспресс аудит НЕ является обязательным бухгалтерским аудитом для налоговой, а выполняет ознакомительные функции для осуществления контроля для владельца бизнеса.</p>
                <p>В отличие от обычного аудита, такая процедура не отнимает много времени и доступна по стоимости. При этом в результате клиент получает достоверные сведения о положении дел в бухгалтерии и рекомендации по решению возможных проблем. Цели проведения бухгалтерского экспресс аудита заключаются в получении квалифицированного заключения и рекомендаций в сжатые сроки при разумных затратах.</p>

                <h3>Срочное проведение экспресс аудита для компании необходимо, если:</h3>
                <ol>
                    <li>Руководитель хочет получить срочную объективную информацию о ситуации в учете.</li>
                    <li>Бухгалтер неожиданно увольняется.</li>
                    <li>Растет количество требований от контролирующих организаций.</li>
                </ol>
                <p>Мы перечислили только часть возможных ситуаций по необходимости срочного аудита. Центр профессиональной бухгалтерии предлагает провести оперативную и профессиональную проверку вашей бухгалтерии. Мы быстро выявим проблемы в учете и предложим пути решения.</p>

                <h3>Что входит в экспресс аудит?</h3>
                <ol>
                    <li>Оценка применяемого плана счетов и качества учета.</li>
                    <li>Контроль расчета начислений платежей в бюджет.</li>
                    <li>Анализ полного комплекта отчетности – бухгалтерского баланса, налоговых деклараций в ФНС и документации в ПФР.</li>
                </ol>
                <p>Порядок проведения позволяет получить оперативные сведения об эффективности работы бухгалтерии и максимально снизить налоговые риски.</p>
                <p><strong>Конфиденциально!</strong> Наша компания действует в интересах клиента и дорожит своей репутацией. Поэтому перед началом проверки мы подписываем соглашение о неразглашении информации (NDA). Результаты аудита знает только собственник фирмы.</p>

                <h3>Этапы экспресс аудита бухгалтерии</h3>
                <ol>
                    <li><strong>Получение сведений.</strong> Для бухгалтерского аудита необходим только доступ к информационной базе. Клиент предоставляет его после подписания договора.</li>
                    <li><strong>Анализ бухгалтерского учета.</strong> Его проводит профессиональный консультант с опытом работы в бухгалтерии свыше 20 лет. Для поиска ошибок применяется чек-лист, который оценивает свыше 100 параметров учета.</li>
                    <li><strong>Оформление результатов проверки.</strong> На основе анализа бухгалтерской базы наш эксперт готовит отчеты о состоянии бухгалтерии и дает рекомендации по устранению выявленных ошибок. В процессе аудита бухгалтерской отчетности мы ищем возможности сэкономить на налогах и других платежах и даем соответствующие рекомендации собственнику бизнеса.</li>
                </ol>

                <h3>Что получают наши клиенты?</h3>
                <p>По итогам аудита наша фирма представляет заключение. В нем содержатся:</p>
                <ol>
                    <li>Профессиональная экспертиза ведения бухгалтерии.</li>
                    <li>Выявленные ошибки в учете и стоимостная оценка их последствий.</li>
                    <li>Предложения по исправлению ситуации.</li>
                </ol>
                <p>Дополнительно клиент получает консалтинговую услугу. Это обратная связь от эксперта, который проводит проверку. Он акцентирует внимание на проблемных областях в учете, отвечает на вопросы, возникшие после проверки, и дает пояснения по результатам аудита.</p>
                <p>Наша аутсорсинговая бухгалтерская компания проводит интенсивный аудит за короткий срок, высказывает квалифицированное мнение об учете и предлагает рекомендации по устранению ошибок. Специалисты нашей компании внимательно изучают проблемы клиентов, и за 5 лет помогли сэкономить на налогах 800 млн. руб.</p>

                <h3>Как проходит экспресс аудит бухгалтерии организации?</h3>
                <p>Аудит проводится удаленно. Вы можете находиться в Казани, Тюмени или рядом в Москве. Бухгалтерия организации продолжает трудиться в штатном режиме и не отвлекается на вопросы тех экспертов, кто проводит контрольные мероприятия. Наши аудиторы работают не только с фирмами из Москвы, но и по всей России.</p>
                <p>Мы осуществляем проверку предприятий всех форм собственности: ИП, ООО, АО (ОАО и ПАО). В отличие от восстановления бухгалтерского учета и бухгалтерской экспертизы, экспресс аудит проводят в максимально сжатые сроки. Вы быстро узнаете о состоянии бухгалтерии в компании, и у вас будет возможность исправить ошибки и скорректировать неточности накануне налоговой проверки или до наступления отчетного периода.</p>

                <h3>Стоимость услуги бухгалтерский аудит</h3>
                <p>Цена услуги экспресс аудита бухгалтерии от 15 000 руб. Затраты на такой вид бухгалтерского обслуживания полностью оправдывают себя. Стоимость экспресс аудита намного ниже, чем финансовые потери при неправильном ведении учета.</p>
                <p>Цены на услуги мы определяем индивидуально для каждого клиента. Узнать об условиях сотрудничества для вашей фирмы и получить подробный прайс-лист вы можете, позвонив по телефону или оставив заявку на обратный звонок.</p>
                <p>Экспресс аудит – это оперативное и комплексное исследование учетного процесса и отчетности предприятия. Такая проверка выполняется быстро, и ее стоимость невысока. В результате руководитель получает экспертную оценку ситуации в бухгалтерском учете и рекомендации по исправлению ошибок в финансовой документации.</p>
                <p>Если вы хотите чувствовать себя уверенно и не сталкиваться с проблемами в учете, получите подробную консультацию об аудиторских услугах бухгалтерии от наших специалистов.</p>
            </div>
        </div>
