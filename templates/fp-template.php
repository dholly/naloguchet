        ...
        <div class="hero-wrapper">
          ...
          <div class="hero-content">
            ...
            <div class="hero-buttons">
              <button class="btn btn_arr" type="button">Узнать стоимость</button>
              <button class="btn btn_arr" type="button">
                <span class="btn-video-text">Смотреть видео</span>
              </button>
            </div>
          </div>
      ...
      <div class="advantages-section__container">
        ...
        <div class="advantages-grid">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Опытные специалисты</h3>
            <p class="card-text">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Юридическая защита</h3>
            <p class="card-text">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Двойной контроль качества</h3>
            <p class="card-text">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Гарантия стабильности</h3>
            <p class="card-text">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Работаем в CRM клиента</h3>
            <p class="card-text">
          ...
          <div class="advantage-card">
            ...
            <h3 class="card-title">Партнёрская атмосфера</h3>
            <p class="card-text">
        ...
        <div class="stats-list">
          ...
          <div class="stats-row">
            <div class="stat-btn-wrapper">
              <a href="#" class="btn btn_arr">Аутсорсинг <br>бухгалтерии для ИП</a>
            </div>
    ...
    <section class="tiles-block">
      <div class="tiles-block__container">
        <h2 class="tiles-block__header">
          Знаем специфику вашей отрасли и
          <br> <span class="text-blue"> сразу называем цены </span>
        </h2>
        ...
        <div class="tiles-grid">
          ...
          <div class="industry-card">
            ...
            <p class="card-desc">Учёт онлайн-продаж <br>и маркетплейсов</p>
          ...
          <div class="industry-card">
            ...
            <p class="card-desc">Контроль поставок, <br>зарплаты и списаний</p>
          ...
          <div class="industry-card">
            ...
            <p class="card-desc">Прозрачный учёт услуг <br>и зарплат мастеров</p>
          ...
          <div class="industry-card">
            <div class="card-header">
              ...
              <h3 class="card-title">Гостиницы <br>и хостелы</h3>
            </div>
            <p class="card-desc">Ведение учёта бронирований <br>и договоров</p>
          ...
          <div class="industry-card">
            <div class="card-header">
              ...
              <h3 class="card-title">Строительные <br>компании</h3>
            </div>
            <p class="card-desc">Учёт подрядов, смет, НДС <br>по стройматериалам</p>
          ...
          <div class="industry-card">
            ...
            <p class="card-desc">Учёт лицензий, зарплат <br>персонала, кассовой дисциплины</p>
            <div class="card-price">от 40 000 ₽/мес</div>
          </div>
        </div>
        ...
        <div class="case-tiles__grid">
          ...
          <div class="case-card">
            ...
            <img class="case-card__icon"
                 src="<?php echo get_template_directory_uri(); ?>\static\img\icons\tiles\online_shops.svg"
                 alt="Online shops Icon">
            ...
            <div class="case-card__desc">
              ...
              <p>
                Снизили задолженность по <br>налогам на <span class="text-blue">3,7 млн ₽ (–88%)</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="industries-footer">
          <div class="footer-left">
            <img src="<?php echo get_template_directory_uri(); ?>\static\img\icons\tiles\spheres2.png"
                 alt="sphere icons" class="sphere-img">
            <span class="spheres-text">Еще более 40 реальных <br>результатов наших клиентов</span>
          </div>
