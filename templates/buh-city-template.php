      ...
      <div class="hero-section__container">
        ...
        <div class="hero-wrapper">
          ...
          <div class="hero-content">
            <h1 class="hero-title">
              Аутсорсинг бухгалтерии <span class="text-blue">в Санкт-Петербурге</span>
            </h1>
    ...
    <section class="stats-section">
      <div class="stats__container">
        <h2 class="stats-title">
          ...
          <span class="text-blue">в Санкт-Петербурге</span>
        </h2>
    ...
    <section class="tiles-block">
      <div class="tiles-block__container">
        <h2 class="tiles-block__header">
          Знаем специфику работы в Санкт-Петербурге и сразу называем цены
        </h2>
